...
public abstract class AbstractTest {
    ...
    protected GuacamoleConfiguration newConfiguration() {
        GuacamoleConfiguration conf = new GuacamoleConfiguration();
        conf.setGuacamoleURL("http://localhost:8080/guacamole/api");
        conf.setGuacamoleDataSource("dummy");
    ...
    protected ConnectorFacade newFacade() {
        ...
        APIConfiguration impl = TestHelpers.createTestConfiguration(LocalGuacamoleConnector.class, newConfiguration());
