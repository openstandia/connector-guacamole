...
public class GuacamoleFilter {
    ...
    public GuacamoleFilter(String attributeName, FilterType filterType, String attributeValue) {
        this.attributeName = attributeName;
        this.filterType = filterType;
        this.attributeValue = attributeValue;
    }

    public GuacamoleFilter(String attributeName, FilterType filterType) {
        this.attributeName = attributeName;
        this.filterType = filterType;
